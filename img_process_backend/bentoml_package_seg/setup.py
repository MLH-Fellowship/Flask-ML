...
setuptools.setup(
    name='PytorchImageSegment',
    version='20201009125205_5509D4',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - PytorchImageSegment:20201009125205_5509D4
...
""",
    ...
    package_data={
        'PytorchImageSegment': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'PytorchImageSegment=PytorchImageSegment:cli',
        ],
    }
)
