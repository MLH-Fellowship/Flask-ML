...
setuptools.setup(
    ...
    version='20201008191758_DAF5E5',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - PytorchImageClassifier:20201008191758_DAF5E5
...
""",
    ...
    package_data={
        'PytorchImageClassifier': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'PytorchImageClassifier=PytorchImageClassifier:cli',
        ],
    }
)
